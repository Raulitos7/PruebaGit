...
cin>>numero2;
cout<<"\nLa suma de ambos numeros es: "<<calcular_suma(numero1,numero2)<<endl;
cout<<"La resta de ambos numeros es: "<<calcular_resta(numero1,numero2)<<endl;
cout<<"La multiplicacion de ambos numeros es: "<<calcular_multiplicacion(numero1,numero2)<<endl;
cout<<"La division de ambos numeros es: "<<calcular_division(numero1,numero2)<<endl;
return 0;
}
int calcular_suma(int operando1,int operando2){
